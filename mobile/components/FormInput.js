...
const FormInput = ({ labelValue, placeholderText, iconType, color, secureTextEntry=false, editable=true, isRequired=false, isPassword=false, isDate=false, ...restProps }) => {
    return (
        <View>
